...
static const char *changewallcmd[] = {
    "/home/nadim/.config/dwmblocks/change_wallpaper.sh", NULL};
static const char *roficmd[] = {"/home/nadim/.config/rofi/scripts/launcher_t3",
                                NULL};
static const char *logoutcmd[] = {"lxqt-leave", NULL};
...
static const char *voldown[] = {"pactl", "set-sink-volume", "@DEFAULT_SINK@",
                                "-5%", NULL};
static const char *mutetoggle[] = {"pactl", "set-sink-mute", "@DEFAULT_SINK@",
                                   "toggle", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY, XK_r, spawn, {.v = remminacmd}},
    {MODKEY, XK_w, spawn, {.v = changewallcmd}},
